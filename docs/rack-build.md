...
<img src="../docs/pictures/rack_10inch-dimensions.svg" alt="aluprofil" width="70%"/>

I decided to build the rack itself with Aluminium Profiles with the size of `20 x 20 mm`. 

<img src="../docs/pictures/rack_aluprofile-20x20.jpg" alt="aluprofil" width="70%"/>

<br>Furthermore I want this rack to fit inside an Ikea Kallax shelf. This has inside dimensions of `33.5 x 33.5 cm`. By taking into account some space for an anti-scratch tape, the max. height of the server rack is limited to `33 cm`.
